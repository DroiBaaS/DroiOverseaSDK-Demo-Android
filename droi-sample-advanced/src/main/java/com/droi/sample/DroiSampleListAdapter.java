...
class DroiSampleListAdapter extends ArrayAdapter<DroiSampleAdUnit> {
    ...
    DroiSampleListAdapter(final Context context, TrashCanClickListener listener) {
        super(context, 0, new ArrayList<DroiSampleAdUnit>());
        mListener = listener;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        final DroiSampleAdUnit sampleAdUnit = getItem(position);
    ...
    private boolean isFirstInSection(int position) {
        ...
        final DroiSampleAdUnit previous = getItem(position - 1);
        final DroiSampleAdUnit current = getItem(position);
