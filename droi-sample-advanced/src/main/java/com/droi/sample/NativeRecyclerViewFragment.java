...
import com.droi.nativeads.DroiRecyclerAdapter;
...
public class NativeRecyclerViewFragment extends Fragment {
    private DroiRecyclerAdapter mRecyclerAdapter;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container,
        ...
        mRecyclerAdapter = new DroiRecyclerAdapter(getActivity(), originalAdapter,
                new DroiNativeAdPositioning.DroiServerPositioning());

        DroiStaticNativeAdRenderer droiStaticNativeAdRenderer = new DroiStaticNativeAdRenderer(
        ...
        mRecyclerAdapter.registerAdRenderer(droiStaticNativeAdRenderer);
