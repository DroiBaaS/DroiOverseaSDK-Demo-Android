...
class DroiSampleAdUnit implements Comparable<DroiSampleAdUnit> {
    ...
    static final Comparator<DroiSampleAdUnit> COMPARATOR =
            new Comparator<DroiSampleAdUnit>() {
                @Override
                public int compare(DroiSampleAdUnit a, DroiSampleAdUnit b) {
    ...
    static class Builder {
        ...
        DroiSampleAdUnit build() {
            return new DroiSampleAdUnit(this);
        }
    }
    ...
    private DroiSampleAdUnit(final Builder builder) {
    ...
    static DroiSampleAdUnit fromBundle(final Bundle bundle) {
        ...
        final Builder builder = new DroiSampleAdUnit.Builder(adUnitId, adType);
    ...
    @Override
    public int compareTo(@NonNull DroiSampleAdUnit that) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DroiSampleAdUnit)) {
            return false;
        }

        final DroiSampleAdUnit that = (DroiSampleAdUnit) o;
