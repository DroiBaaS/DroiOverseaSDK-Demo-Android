...
import com.droi.nativeads.DroiStreamAdPlacer;
...
public class NativeGalleryFragment extends Fragment implements DroiNativeAdLoadedListener {
    private DroiSampleAdUnit mAdConfiguration;
    private ViewPager mViewPager;
    private CustomPagerAdapter mPagerAdapter;
    private DroiStreamAdPlacer mStreamAdPlacer;
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final DroiStaticNativeAdRenderer droiStaticNativeAdRenderer = new DroiStaticNativeAdRenderer(
        ...
        mStreamAdPlacer = new DroiStreamAdPlacer(getActivity());
        mStreamAdPlacer.registerAdRenderer(droiStaticNativeAdRenderer);
    ...
    public DroiStreamAdPlacer getAdPlacer() {
    ...
    public void onResume() {
        // Droi recommends reloading ads when the user returns to a view.
        mStreamAdPlacer.loadAds(mAdConfiguration.getAdUnitId(), mRequestParameters);
        super.onResume();
    }
    ...
    private static class CustomPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public CustomPagerAdapter(final FragmentManager fragmentManager,
                DroiStreamAdPlacer streamAdPlacer) {
    ...
    public static class AdFragment extends Fragment {
        ...
        private DroiStreamAdPlacer mAdPlacer;
